...
if($count==0){
    ...
    $rows=mysqli_num_rows($DatabaseCo->dbLink->query("SELECT * FROM contact_view JOIN register_view ON contact_view.viewed_mem_id=register_view.matri_id WHERE contact_view.my_id='$matri_id' AND gender!='$gender' ORDER BY con_id DESC")); 
    $sql = "SELECT * FROM contact_view JOIN register_view ON contact_view.viewed_mem_id=register_view.matri_id WHERE
contact_view.my_id='$matri_id' AND gender!='$gender' ORDER BY con_id DESC";
