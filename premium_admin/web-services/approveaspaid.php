...
?>
<div class="md-content md-effect-13" id="dialog" style="width:60% !important; margin-top:2%;">
  <div class="modal-header">
    <span id="new_button">
      <button class="md-close close" id="old"  data-dismiss="modal">&times;
      </button>
    </span>
    <h4 class="modal-title" id="myModalLabel">Approve Active To paid
    </h4>
  </div>
          ...
          <div class="thumbnail">
            ...
            <?php
          	...
          	<?php 
           	...
           	?>
            <img src="img/female.png" alt="User Image" height="150" width="130" border="1" />
            <?php }else{ ?>
			 <img src="img/male.png" alt="User Image" height="150" width="130" border="1" />	
			<?php } ?>
            <?php	
				}
			  ?>
        ...
        <div class="col-xs-12 col-lg-8 col-sm-8" >
          <div class="form-group col-xs-8">
            ...
            <label for="exampleInputEmail1">
              ...
              <span class="hidden-xs">Featured
              </span>
              <?php }?>
              <?php if($row['status']=='Paid'){?>
              <i class="fa fa-money">
              </i>
              <span class="hidden-xs">Paid
              </span>
              <?php }elseif($row['status']=='Active'){?>
              <i class="fa fa-thumbs-up">
              </i>
              <span class="hidden-xs">Active
              </span>
              <?php }elseif($row['status']=='Inactive'){?>
              <i class="fa fa-thumbs-down text-danger">
              </i>
              <span class="hidden-xs">Inactive
              </span>
              <?php }elseif($row['status']=='Suspended'){?>
              <i class="fa fa-user-times text-danger">
              </i>
              <span class="hidden-xs">Suspended
              </span>
              <?php }?>
            </label>
          </div>
          ...
          <div class="form-group col-xs-12">
            <label for="exampleInputEmail1">City : 
              <?php echo $row['city_name']; ?> &nbsp; &nbsp; State : 
              <?php echo $row['state_name']; ?> &nbsp; &nbsp; Country : 
            ...
            <div class="form-group form-group-select2">
              ...
              <div class="col-xs-6">
                <select class="form-control" name="pay_mode" id="pay_mode">
                  ...
                  <option value="Funds Transfer">Funds Transfer
                  </option>
        ...
        <!-- <div class="row" style="margin-top:3%;">
          ...
          <div class="row mt-10">
            <div class="form-group form-group-select2">
              ...
              <div class="col-xs-6">   
                <textarea name="bankdet" cols="30" rows="4"  id="bankdet" class="form-control">
                </textarea>
              </div>
            </div>
          </div>
