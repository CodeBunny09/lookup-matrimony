...
if(isset($Row)){
    ...
    <?php } else {?>
		<?php 
			if(($Row->photo1!="" && $Row->photo1_approve=='APPROVED' ) && (($Row->photo_view_status=='1') || ($Row->photo_view_status=='2' && $_SESSION['mem_status']=='Paid')) && (($Row->photo_protect=='No') || ($Row->photo_protect=="Yes" && $Row->photo_pswd==''))){ 		   
		?>
