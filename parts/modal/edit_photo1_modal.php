  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
       	<div class="col-12">
        	<h5 class="modal-title" id="exampleModalLabel">Edit Profile Picture
      ...
      <div class="modal-body">
       	<form action="" method="post" enctype="multipart/form-data" class="editPhotoModal">
        	...
        	<div class="col-xxl-10 col-xxl-offset-3">
				<center>
   				<?php if($Row->photo1 != ''){?>
   					<img src="my_photos/<?php echo $Row->photo1; ?>" class="img-fluid img-thumbnail" id="photo1_prev">
   				<?php }else{?>
   					<?php if($Row->gender =='Female'){ ?>
   						<img src="img/female.png" class="img-fluid img-thumbnail" id="photo1_prev">
					<?php }else{ ?>
 						<img src="img/male.png" class="img-fluid img-thumbnail" id="photo1_prev">
  					<?php } ?>
   				<?php }?>
