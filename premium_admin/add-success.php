                    ...
                    <form action="" enctype="multipart/form-data" method="post" class="form-data gtNewMemPlan" id="add_form" class="">
                      <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="groomid" value="<?php
                                                                                        ...
                                                                                        ?>" id="groomid" title="groomid" data-validetta="required"/>
                        </div>
                        <div class="form-group">
                          <label>
                            Groom Name :
                      ...
                      <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                          ...
                          <textarea name="successmessage" id="successmessage" data-validetta="required" class="form-control" rows="10" ><?php if ($story_id != '') { echo $row['successmessage']; } ?></textarea>
                        </div>
                        <div class="form-group">
                          <label>
                            Marrage Date :
