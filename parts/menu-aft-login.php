                    ...
                    <li class="dropdown gt-border-right-green">
                        <a href="#" class="dropdown-toggle ripplelink gt-padding-left-30 gt-padding-right-30" data-toggle="dropdown" role="button" aria-expanded="false">
							...
							<span class="badge" style="position:absolute;top:8px;right: 16px;">
								<?php  if ($res_reminder->num_rows > 0){ echo $count=$res_reminder->num_rows; }else{ echo $count= 0;}?>
							</span>
                        </a>
                        <ul class="dropdown-menu">
                            <?php if ($res_reminder->num_rows > 0) { ?>
                                ...
                                while ($res = mysqli_fetch_object($res_reminder)) {
                                    ...
                                    <li>
										<a href="<?php 
													if($res->notification_type == 'Express Interest'){
														echo 'exp-interest';
													}elseif($res->notification_type == 'Message'){
														echo 'inboxMessages';
													}elseif($res->notification_type == 'Photo Password'){
														echo 'photo-request'; }?>" onClick="notification('<?php echo $res->noti_id; ?>') ">
