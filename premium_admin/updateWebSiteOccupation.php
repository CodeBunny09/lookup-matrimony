              ...
              <div class="box-top updateSite">
                <div class="row">
                  ...
                  <div class="col-lg-3 col-xs-12 col-sm-4">
                    <a href="updateWebSiteOccupation?occupation_status=all" class="btn btn-success btn-lg col-xs-12">
                      <i class="fa fa-list">
                      </i>All Occupation 
                      <span class="badge">
                        <?php echo getRowCount("select count(ocp_id) from occupation",$DatabaseCo);?>
                      </span>
                    </a>
                  </div>
                  <div class="col-lg-3 col-xs-12 col-sm-4">
                    <a href="updateWebSiteOccupation?occupation_status=approved" class="btn btn-success btn-lg col-xs-12">
                      <i class="fa fa-thumbs-up">
                      </i>Approved Occupation 
                      <span class="badge">
                        <?php echo getRowCount("select count(ocp_id) from occupation where status='APPROVED'",$DatabaseCo);?>
                      </span>
                    </a>
                  </div>
                  <div class="col-lg-3 col-xs-12 col-sm-4">
                    <a href="updateWebSiteOccupation?occupation_status=unapproved" class="btn btn-success btn-lg col-xs-12">
                      <i class="fa fa-thumbs-down">
                      </i>Unapproved Occupation 
                      <span class="badge">
                        <?php echo getRowCount("select count(ocp_id) from occupation where status='UNAPPROVED'",$DatabaseCo);?>
                      </span>
                    </a>
                  </div>
                </div>
...
?>     
            ...
            <?php
$main_menu_count = getRowCount("select count(ocp_id) from occupation".getWhereClauseForStatus($occupation_status),$DatabaseCo);
if($main_menu_count>0){  
$SQL_STATEMENT =  "SELECT * FROM occupation ".getWhereClauseForStatus($occupation_status)." ORDER BY ocp_id DESC";
?>
            ...
            <div class="col-xs-12 mt-10">
              ...
              <div class="box box-success">
                <div class="box-header">
                  <h4 class="">
                    <?php echo strtoupper($occupation_status); ?> OCCUPATION LIST
                  </h4>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  <form method="post" action="updateWebSiteOccupation" id="action_form">
...
?>
                        <tr>
                          <td>
                            <input type="checkbox" name="ocp_id[]" id="Item <?php  echo $DatabaseCo->dbRow->ocp_id;?>" class="second" value="<?php  echo $DatabaseCo->dbRow->ocp_id;?>"/>
                            <label for="Item <?php  echo $DatabaseCo->dbRow->ocp_id;?>" class="label2">&nbsp;
                            </label>   
                          </td>
                          <td>
                            <a class="btn btn-default btn-sm md-trigger edit-popup"  href="javascript:;" data-modal="modal-13" data-id="<?php  echo $DatabaseCo->dbRow->ocp_id;?>" data-ocp_name="<?php  echo $DatabaseCo->dbRow->ocp_name;?>" data-ocp_status="<?php  echo $DatabaseCo->dbRow->status;?>">
...
?>
            <div class="col-lg-12 col-xs-12 col-sm-12">
              <h4>There are no data for 
                <?php echo strtoupper($occupation_status); ?> Ocucupation. Please add data.
              </h4>
              <br/>
...
?>   
    ...
    <div class="md-modal" id="modal-13">
      <div class="md-content" id="dialog">
        <div class="modal-header" >
          ...
          <h4 class="modal-title" id="dialog_title">Add New Occupation
          </h4>
        </div>
        <div class='error-msg' id='validationSummary'>
        </div>
        <form method="post" id="ocp-form" action="" method="post">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" name="ocp_name" class="form-control" id="ocp_name" placeholder="Enter occupation name">
            </div>
            <div class="form-group">
              <label>
                <b>Status
              ...
              <div class="radio">
                <input id="optionsRadios1" class="occupation_status" type="radio" checked="" value="APPROVED" name="occupation_status">
                <label for="optionsRadios1">
                  <b>Active
                  </b> 
                </label>
                <input id="optionsRadios2" class="occupation_status" type="radio" value="UNAPPROVED" name="occupation_status">
          ...
          <div class="modal-footer updateSite">
            ...
            <input type="hidden" name="ocp_id" id="ocp_id" value=""/>
    ...
    <script type="text/javascript">
      $(function () {
        ...
        $("input[name=ocp_id]").click(function(){
        ...
        $(document).on("click", ".edit-popup", function () {
          ...
          var ocp_name = $(this).data('ocp_name');
          var ocp_status = $(this).data('ocp_status');
          $("#ocp_id").val(myid);
          $("#ocp_name").val(ocp_name);
          $("#save").val("Update");
          $("#dialog_title").text("Update Occupation");
          if(ocp_status=='APPROVED')
          {
        ...
        $("#save" ).button().click(function(){
          ...
          var dataString =  $("#ocp-form").serialize();
          $.ajax({
            type: "post",
            url: "web-services/add-details/add_occupation",
            dataType:"json",
            data: dataString,
            success: function(data){
              if(data.successStatus){
                ...
                $("#validationSummary").show();
                $("#old").remove();
                $('<a href="updateWebSiteOccupation" id="old" class="md-close close">&times;</a>').appendTo('#new_button');
              }
              else{
