  ...
  <div class="row">
    ...
    <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-16 col-sm-16 col-xs-16 gt-padding-bottom-10 gt-padding-top-10 gt-view-detail">
      <div class="row">
        ...
        <div class="col-xs-10">
          <b>
            <?php echo $DatabaseCo->dbRow->part_frm_age.' Years';?> &nbsp;&nbsp;&nbsp;&nbsp;To &nbsp;&nbsp;&nbsp;&nbsp;
            <?php echo $DatabaseCo->dbRow->part_to_age.' Years'; ?>
          </b>
        </div>	
      </div>
    </div>
    <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-16 col-sm-16 col-xs-16 gt-padding-bottom-10 gt-padding-top-10 gt-view-detail">
      <div class="row">
        ...
        <div class="col-xs-10">
          <b>
            <?php $ao3 = $DatabaseCo->dbRow->part_height;$ft3= (int) ($ao3/12);$inch3 = $ao3 % 12;echo $ft3."ft". " ".$inch3."in";?> &nbsp;&nbsp;&nbsp;&nbsp; To  &nbsp;&nbsp;&nbsp;&nbsp;
            <?php $ao2 = $DatabaseCo->dbRow->part_height_to;$ft2= (int) ($ao2/12);$inch2 = $ao2 % 12;echo $ft2."ft". " ".$inch2."in";?>
          </b>
        </div>	
      </div>
    </div>
