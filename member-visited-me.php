    ...
    <div class="container gt-margin-top-20">
    	<div class="row">
        	<aside class="col-xxl-12 col-xxl-offset-4 col-xl-12 col-xl-offset-4 text-center">
                ...
                <article>
                	<p>
                    	You can check all of your My Profile Viewd By members list here.
                    </p>
                </article>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var dataString = 'result_status=memvisitedme&actionfunction=showData' + '&page=1';
		...
		$('#pagination').on('click','.page-numbers',function(){
		   ...
		   var dataString = 'result_status=memvisitedme&actionfunction=showData' + '&page='+$page;
