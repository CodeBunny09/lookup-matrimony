...
if($count==0){
	...
	$sel_own_data = $DatabaseCo->dbLink->query("select index_id,birthdate,ocp_name,height,city_name,country_name,state_name,photo1_approve,photo1,photo_view_status,photo_protect,photo_pswd,gender,username,matri_id,religion_name,caste_name,edu_detail,tokan,status,firstname,lastname from register_view where matri_id!='$matri_id' and gender!='$gender' and status!='Inactive' and status!='Suspendade' $c order by reg_date ASC");
