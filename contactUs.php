  		...
  		<div id="wrap">
  			<div id="main">
    			...
    			<div class="container">
                	...
                	<p class="text-center">Feel free to contact us you can ask your questions and query here.</p>
                						...
                						<div class="gt-panel-body">
                    						<div class="row">
                    							<div class="col-xxl-16">
                        							<?php 
														$get_add1=mysqli_fetch_object($DatabaseCo->dbLink->query("select cms_content from cms_pages where cms_id='9' and status='APPROVED'"));
														if(isset($get_add1)){
            						...
            						<div class="gt-panel">
                						...
                						<div class="gt-panel-body">
                    						<div class="row">
                    							<div class="col-xxl-16">
                        						<?php 
													$get_add12=mysqli_fetch_object($DatabaseCo->dbLink->query("select cms_content from cms_pages where cms_id='17' and status='APPROVED'"));
													if(isset($get_add12)){
