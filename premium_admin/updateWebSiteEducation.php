...
<html>
   <head>
      <meta charset="UTF-8">
      <title>Admin | Manage Education </title>
         ...
         <div class="content-wrapper">
            ...
            <section class="content">
               <div class="row">
                           ...
                           <form method="post" action="updateWebSiteEducation" id="action_form">
                              <table id="example1" class="table table-bordered table-striped">
                                 ...
                                 <tbody>
                                    ...
                                    ?>
                                    <tr>
                                       <td><input type="checkbox" name="edu_id[]" id="Item <?php  echo $DatabaseCo->dbRow->edu_id;?>" class="second" value="<?php  echo $DatabaseCo->dbRow->edu_id;?>"/>
                                          <label for="Item <?php  echo $DatabaseCo->dbRow->edu_id;?>" class="label2">&nbsp;</label>	
                                       </td>
                                       <td><a class="btn btn-default btn-sm md-trigger edit-popup"  href="javascript:;" data-modal="modal-13" data-id="<?php  echo $DatabaseCo->dbRow->edu_id;?>" data-edu_name="<?php  echo $DatabaseCo->dbRow->edu_name;?>" data-edu_status="<?php  echo $DatabaseCo->dbRow->status;?>"><i class="fa fa-pencil fa-fw"></i><span class="hidden-xs">&nbsp;&nbsp;Edit</span>
                                          </a>
                                       </td>
                                       <?php
                                          $likeDisLikeCss = "";
                  ...
                  ?>
                  <div class="col-lg-12 col-xs-12 col-sm-12">
                     <h4>There are no data for <?php echo strtoupper($edu_status); ?> Education. Please add data.</h4>
                     <br/>
            ...
            <form method="post" id="edu-form" action="" method="post">
               <div class="modal-body">
                  <div class="form-group">
                     <label for="exampleInputEmail1"><b>Education Name</b></label>
