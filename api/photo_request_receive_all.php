...
if($count==0){
	$receiver_id=$_POST['ph_reqid'];
	$sel_own_data=$DatabaseCo->dbLink->query("select * from photoprotect_request c1,register_view c2 where c1.ph_receiver_id='$receiver_id' and c1.ph_requester_id=c2.matri_id ");
