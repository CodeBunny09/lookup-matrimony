<?php
	...
	if(isset($_POST['religion'])){
		$religion=mysqli_real_escape_string($DatabaseCo->dbLink,$_REQUEST['religion']);
		$caste=mysqli_real_escape_string($DatabaseCo->dbLink,$_REQUEST['caste']);
		$subcaste=mysqli_real_escape_string($DatabaseCo->dbLink,$_REQUEST['subcaste']);
		$will=mysqli_real_escape_string($DatabaseCo->dbLink,$_REQUEST['will_to_marry']);
		$DatabaseCo->dbLink->query("UPDATE register SET religion='$religion',caste='$caste',subcaste='$subcaste',will_to_mary_caste='$will' where matri_id='$matri_id'");
		$result3 = $DatabaseCo->dbLink->query("SELECT * FROM register,site_config where matri_id = '$matri_id'");
						...
						$subject = "Religion Information Updated";	
					$message = "
                   <!doctype html>
<html>
...
<body  style='margin: 0 auto;padding-top:20px;padding-bottom:20px;background: rgba(233,233,233,1.00);'>
    ...
    border-radius: 5px;background-color:white;'>
		...
		<div id='gtstrip' style='background: #ea2626;padding: 10px;text-align:center;'>
				<h5 style='font-size: 40px;font-weight:500;font-family: Roboto, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #fff;padding: 10px 15px 10px 15px;'>Religion details updated</h5>
		</div>
	...
	$SQLSTATEMENT=$DatabaseCo->dbLink->query("select religion,caste,subcaste,will_to_mary_caste from register where matri_id='$matri_id'");
                    	...
                    	<div class="row">
                        	<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-16 col-sm-16 col-xs-16 gt-padding-bottom-10 gt-padding-top-10 gt-view-detail">
                            	<div class="row">
                                    ...
                                    <div class="col-xs-10">
									    ...
									    echo $DatabaseCo->Row->religion_name; ?></b>
                                    </div>	
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-16 col-sm-16 col-xs-16 gt-padding-bottom-10 gt-padding-top-10 gt-view-detail">
                            	<div class="row">
                                    ...
                                    <div class="col-xs-10">
                                    	<?php if($DatabaseCo->dbRow->subcaste == '' || $DatabaseCo->dbRow->subcaste == 'Not Available' ){ ?>
                                    	<b>Not Available</b>
                                    	<?php }else{?>
                            ...
                            <div class="col-xxl-16 col-xl-16 col-lg-16 col-md-16 col-sm-16 col-xs-16 gt-padding-bottom-10 gt-padding-top-10 gt-view-detail">
                            	<div class="row">
                                    ...
                                    <div class="col-xs-10">
                                    	<b><?php if($DatabaseCo->dbRow->will_to_mary_caste!='' && $DatabaseCo->dbRow->will_to_mary_caste=='1'){ echo "Yes"; }elseif($DatabaseCo->dbRow->will_to_mary_caste!='' && $DatabaseCo->dbRow->will_to_mary_caste=='0'){ echo "No";} else{ echo "Not Available";}?></b>
                                    </div>	
                                </div>
                            </div>
							<?php } ?>
