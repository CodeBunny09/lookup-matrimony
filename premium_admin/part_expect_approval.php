...
$configObj = new Config();
$expect_status = "";
if(isset($_GET['expect_status']))
{
$expect_status = $_GET['expect_status'];
$_SESSION['expect_status'] = $_GET['expect_status'];
}
else if(isset($_GET['page']))
{
$expect_status = $_SESSION['expect_status'];
}
else
{
$_SESSION['expect_status'] = "all";
$expect_status = "all";
}
...
{
case 'Delete':		
$SQL_STATEMENT =  "update register set part_expect='' where index_id in ".$index_val;	
$exe=$DatabaseCo->dbLink->query("select part_expect from register where index_id in ".$index_val);
	  
break;
case 'Approved':
$SQL_STATEMENT =  "update  register set part_expect_approve='Approved' where index_id in ".$index_val;	
break;
case 'Unapproved':
$SQL_STATEMENT =  "update  register set part_expect_approve='Unapproved' where index_id in ".$index_val;	
break;
}
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Manage | Partner Expectation Approval
    </title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Partner Expectation Approval</li>
          </ol>
        </section>
        <!-- Main content -->
        <section class="content">
          ...
          <div class="row">
            <div class="col-lg-12 col-xs-12 col-sm-12">
              <div class="box-top updateSite">
                ...
                <div class="col-lg-3 col-xs-12 col-sm-4">
                  <a href="part_expect_approval.php?expect_status=all" class="btn btn-success btn-lg btn-block">
                    <i class="fa fa-list">
                    </i>All Expectation <span class="badge">
                    <?php echo getRowCount("select count(index_id) from register WHERE part_expect!='' ",$DatabaseCo);?></span>
                  </a>
                </div>
                <div class="col-lg-3 col-xs-12 col-sm-4">
                  <a href="part_expect_approval.php?expect_status=approved" class="btn btn-success btn-lg btn-block">
                    <i class="fa fa-thumbs-up">
                    </i>Approved Expectation <span class="badge">
                    <?php echo getRowCount("select count(index_id) from register where part_expect!='' AND part_expect_approve='Approved'",$DatabaseCo);?></span>
                  </a>
                </div>
                <div class="col-lg-3 col-xs-12 col-sm-4">
                  <a href="part_expect_approval.php?expect_status=unapproved" class="btn btn-success btn-lg btn-block">
                    <i class="fa fa-thumbs-down">
                    </i>Unapproved Expectation <span class="badge">
                    <?php echo getRowCount("select count(index_id) from register where part_expect!='' AND part_expect_approve='Unapproved'",$DatabaseCo);?></span>
                  </a>
                </div>
				<div class="col-lg-3 col-xs-12 col-sm-4">
                  <a href="part_expect_approval.php?expect_status=pending" class="btn btn-success btn-lg btn-block">
                    <i class="fa fa-thumbs-down">
                    </i>Pending Expectation <span class="badge">
                    <?php echo getRowCount("select count(index_id) from register where part_expect!='' AND part_expect_approve='Pending'",$DatabaseCo);?></span>
                  </a>
                </div>
                </div>
              </div>
            ...
            <?php
			$main_menu_count = getRowCount("select count(index_id) from register".getWhereClauseForExpect($expect_status),$DatabaseCo);
			if($main_menu_count>0)
			{  
			$SQL_STATEMENT =  "SELECT * FROM  register ".getWhereClauseForExpect($expect_status)." ORDER BY part_expect_date DESC";
			?>
        ...
        <div class="col-xs-12 mt-10">
          ...
          <div class="box box-success">
            <div class="box-header">
              <h4>
                <?php echo strtoupper($expect_status); ?> Partner Expectation LIST
              </h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body gtMemPlan">
              <form method="post" action="part_expect_approval" id="action_form">
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th width="37%">Partner Expectation
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php
						$likeDisLikeCss = "";
							if($DatabaseCo->dbRow->part_expect_approve=="Approved"){
								$likeDisLikeCss = "fa-thumbs-up";
							}elseif($DatabaseCo->dbRow->part_expect_approve=="Pending"){
                      ...
                      <td>
                       ...
                       <td>
                        <?php echo $DatabaseCo->dbRow->part_expect_date;?>
                      </td>
                      <td>
...
<script type="text/javascript">
  setPageContext("approval","expect-approve");
</script>	
