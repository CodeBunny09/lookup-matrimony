...
<html>
   <head>
      <meta charset="UTF-8">
      <title>Manage | Active to Paid</title>
	...
	<script>
	  function activetopaid(){
		var dataString = 'actionfunction=showData' + '&page=1' + '&status=Active';
		$("#result").html('<img src="img/ajax_loader_blue_256.gif" style="margin-left:25%;">');
		$.ajax({
		  url:"web-services/memres",
		  type:"POST",
  ...
  <div class="wrapper" style="display:none" id="body">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <ol class="breadcrumb">
                  ...
                  <li class="active"> Active To Paid Members</li>
               </ol>
            </section>
            <!-- Main content -->
      ...
      <script type="text/javascript">
         setPageContext("members","active-to-paid");
      </script>	
      <!-- AdminLTE App -->
