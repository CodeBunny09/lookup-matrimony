...
if($count==0){
	...
	if($ei_id1>0){
		$ph_reqid=$_POST['ph_reqid'];
		$DatabaseCo->dbLink->query("update photoprotect_request set receiver_response='Reject' where ph_reqid='$ph_reqid'");
		$response['status'] = "1";
		$response['message'] = "Photo Req Rejected Successfully";
