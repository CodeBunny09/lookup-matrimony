<li>
                                ...
                                <a href="inbox_main_msg.php?msg_id=<?php echo $DatabaseCo->dbRow->mes_id;?>&sent=1" class="col-xxl-4 col-xs-10 col-sm-10 col-md-8 col-lg-4" data-toggle="tooltip" data-placement="left" title="<?php echo $DatabaseCo->dbRow->to_id;?>" >
                                	<h4 class="name"><?php echo $DatabaseCo->dbRow->to_id;?></h4>
                                </a>
                               
                                <a href="inbox_main_msg.php?msg_id=<?php echo $DatabaseCo->dbRow->mes_id;?>&sent=1" class="col-xxl-8 col-xs-16 col-sm-16 col-md-16 col-lg-8 gt-margin-top-8" title="<?php echo $DatabaseCo->dbRow->to_id;?>">
